...
import calcite.ExtendedRelTypeFactory;
...
public final class XSqlRawTypeNameSpec extends SqlTypeNameSpec {
    ...
    public XSqlRawTypeNameSpec(SqlNode className, SqlNode serializerString, SqlParserPos pos) {
    ...
    public boolean equalsDeep(SqlTypeNameSpec spec, Litmus litmus) {
        if (!(spec instanceof XSqlRawTypeNameSpec)) {
            return litmus.fail("{} != {}", this, spec);
        }
        XSqlRawTypeNameSpec that = (XSqlRawTypeNameSpec) spec;
