 ...
 * xparser.sql.parser.validate.FlinkSqlConformance}, then use this sql conformance to make
 * context aware decisions in parse block. See the usage of {@link
 * xparser.sql.parser.validate.FlinkSqlConformance#HIVE} in {@code parserImpls.ftl}.
 *
