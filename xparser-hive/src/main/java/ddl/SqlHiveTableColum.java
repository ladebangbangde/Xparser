...
public abstract class SqlHiveTableColum extends SqlCall{
    ...
    private SqlHiveTableColum(SqlParserPos pos, SqlIdentifier name, @Nullable SqlNode comment) {
        super(pos);
    ...
    public static class SqlRegularColumn extends SqlHiveTableColum {
    ...
    public static class SqlMetadataColumn extends SqlHiveTableColum {
    ...
    public static class SqlComputedColumn extends SqlHiveTableColum {
